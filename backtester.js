...
const BT = (() => {
    ...
    async function loadData() {
        ...
        try {
            const res = await fetch('https://xkoldzewlcpobtlbwujl.supabase.co/storage/v1/object/sign/factor_data/finalMonthlyLabels_aman%20(1).csv?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV85MGZlNDQ5YS02ODIwLTQyMTAtYjRjNC1iN2FlMmIzNTgyZmIiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJmYWN0b3JfZGF0YS9maW5hbE1vbnRobHlMYWJlbHNfYW1hbiAoMSkuY3N2IiwiaWF0IjoxNzc3MDE3MzI5LCJleHAiOjE4MDg1NTMzMjl9.QX8JFnvcfAuSfln7aG5rbOD4MGxRlKAXzoAcM6Bn2Cc');
